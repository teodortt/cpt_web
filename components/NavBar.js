                    ...
                    <div className="container">
                        ...
                        <div id="navbarSupportedContent" className={`collapse navbar-collapse justify-content-center`}>
                            <ul className="navbar-nav">
                                ...
                                <li className={currentRoute === '/attraction' ? 'nav-item pl-3 active-l' : 'nav-item pl-3'}><span className={navClass}><Link href="/attraction">Attractions</Link></span></li>
                                <li className={currentRoute === '/single-tour#faq' ? 'nav-item pl-3 active-l' : 'nav-item pl-3'}><span className={navClass}><Link href="/single-tour#faq">FAQ</Link></span></li>
