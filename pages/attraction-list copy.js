      ...
      <div className="container-fluid bg-tours pl-0 pr-0">
        ...
        <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
          ...
          <section className="container text-dark attractions-section pt-4">
            ...
            <div className="row justify-content-center align-items-center py-5" style={{ paddingRight: 50 }}>
              ...
              <div className="col-sm-5 text-left">
                <h2 className="text-uppercase pb-4" style={{ color: '#4c4a4b', fontWeight: 800 }}>Hamiltion Monument</h2>
            ...
            <div className="row justify-content-center">
              <img style={{ marginTop: '-100px', width: '50%' }} src="/images/dott-2.png" className="attr-image" />
            </div>

            <div className="row justify-content-center align-items-center py-5" style={{ paddingLeft: 50 }}>


              <div className="col-sm-5 text-left col1">
                <h2 className="text-uppercase pb-4" style={{ color: '#4c4a4b', fontWeight: 800 }}>Alice in Wonderland</h2>
            ...
            <div className="row justify-content-center">
              <img style={{ marginTop: '-50px' }} src="/images/dott.png" className="attr-image" />
            </div>
