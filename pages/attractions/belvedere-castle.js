...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="Belvedere Castle - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>Belvedere Castle</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>And Belvedere is an astonishing structure – with its stone façade, turret, and flag, the castle looks as impressive as any European castle.

                                    Belvedere plays an important role in New York City’s weather forecasts. For more than a century it is used as a measuring point for the wind speed and direction. Rainfall is recorded just to the south.</p>
                                <p>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/belvedere-castle.jpg" width="100%" />
