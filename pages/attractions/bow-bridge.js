...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="Bow Bridge - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>Bow Bridge</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>Bow Bridge is one of the most romantic locations in New York, seen many marriage proposals throughout the ages, as well as one of the most photographed due to its picturesque location over The Lake.</p>
                                <p>
                                ...
                                <p>
                                    ...
                                    Bow Bridge is a cool place located in the center of Central Park. On one hand it's only a bridge but on another hand it's iconic place. Romantic scenery, beautiful view on Bethesda Terrace, breath-taking landscape of Manhattan - ideal place for photo and for making a proposal.
                                </p>
                                <p>
                                    If you are lucky enough, you can see many men making proposals. Must see, must visit. Worth your time!
                                </p>
                            </div>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/bow-bridge-1.jpg" width="100%" />
