...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="Bethesda Fountain - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>Bethesda Fountain</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>The fountain is “crowned” by the “Angel of the Waters” – an eight-foot tall neoclassical bronze sculpture, standing above four small cherubim. The angel holds a lily in one hand and blesses the waters in her feet with the other, thus blessing the waters in the Croton Aqueduct that, back in 1842, was used to supply fresh water to New York City. Actually, the angel gave the name to the whole terrace.It was first considered to be named just “The Water Terrace” in the Greensward Plan, but was named “Bethesda Terrace” after the placement of the monument.</p>
                                <p>
                                ...
                                <p>And to top it all – the monument is a famous movie location, appearing in numerous movies like Ransom, One Fine Day, Tommy Boy, Bullets over Broadway and Hair.</p>
                            </div>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/bethesda-fountain-3.jpg" width="100%" />
