...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="The Reservoir - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>The Reservoir</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>
                                    The Reservoir is one of the most famous running routes. A lot of celebrities enjoy jogging around it, including Madonna, President Clinton and Jackie Kennedy Onassis – who gave the Reservoir its name.                                </p>
                                ...
                                <p>
                                    ...
                                    It was decommissioned in 1993 and up until recently was surrounded by a six foot chain link, that got replaced in 2003 by a far more aesthetic chain fence, turning The Reservoir into a far more pleasant place.
                                </p>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/the-reservoir-centralpark-2.jpg" width="100%" />
