...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="Chess and Checkers - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>Chess and Checkers</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>
                                    ...
                                    It is well-suited for players of all statuses – from rookies to seasoned veterans.                                </p>
                                <p>
                                    The pergola surrounding it was erected in 1986 by the Conservancy to provide shade for the players.                                </p>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/chess-and-checkers-2.jpg" width="100%" />
