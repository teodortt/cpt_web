...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="Swedish Cottage - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>Swedish Cottage</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>
                                    Through the years, the Swedish Cottage served many purposes – a tool house, a library, an entomological laboratory, even a headquarters for the Civil Defense during World War II.                                </p>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/swedish-cottage-3.jpg" width="100%" />
