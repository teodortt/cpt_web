...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="Balto Statue - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>Balto Statue</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>Doctors and town authorities decided to call for help from Anchorage, but this was a mission (nearly) impossible because it was in the middle of the winter.The only way to provide the required medicine was by dogsleds. More than twenty sleds have ventured, and among them was Gunnar Kasson with his team leader Balto – an Alaskan malamute.</p>
                                <p>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/balto-1.jpg" width="100%" />
