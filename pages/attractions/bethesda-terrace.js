...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="Bethesda Terrace - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>Bethesda Terrace</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>The Terrace is scribed with topics such as nature, art, science, and more! There is a more interesting and a bit hidden place called the Arcade. It is under the Terrace and was conceived as a space to shelter visitors from heat and rain. The place is popular amongst singers and musicians due to its amazing acoustics.</p>
                                <p>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/bethesda-terrace-1.jpg" width="100%" />
