...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="Wollman Rink - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>Wollman Rink</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>
                                    Wollman Rink was created back in 1950 in order to replace the Lake, that was used as a skating rink before. The skating season in Central Park usually lasts from October to April. The rink was created with donations from the Wollman family and thus carries their name. It went under a large-scale renovation that turned it into a piece of art, and is currently operated by The Trump Organization.
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    Besides ice skating, Wollman Rink offers ice hockey, figure skating, skating lessons, rentals, lockers, and party facilities.
                                </p>
                                <p>

                                    Wollman Rink has a significant pop culture value, and has appeared in several movies, with the most prominent being “Serendipity”, and “Home Alone 2”.
                                </p>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/wollman-rink-centralpark.jpg" width="100%" />
