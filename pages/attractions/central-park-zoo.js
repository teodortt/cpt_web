...
export default function Attraction() {
    ...
    return (
        <div>
            ...
            <NavBar title="Central Park Zoo - Central Park Tours - The Official Central Park Tour Company" />
            ...
            <div className="container-fluid bg-tours pl-0 pr-0">
                ...
                <div className="pt-5 text-white text-center" style={{ position: "relative" }}>
                    <div className="py-5 mt-5">
                        ...
                        <h1 className="attraction-title" style={{ fontWeight: 900, letterSpacing: '2px', fontSize: '50px' }}>Central Park Zoo</h1>
                    ...
                    <section className="container text-dark attraction-section">
                        ...
                        <div className="row justify-content-center text-left pt-5">
                            <div className="col-md-7 pb-5 pt-5">
                                ...
                                <p>The Zoo is a year-round attraction and has animals from different climate areas, recreating successfully their natural habitats. The Zoo fields a sea lion pool in its center, that has an underwater area offer a peek to their underwater shenanigans.</p>
                                <p>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-9">
                                ...
                                <img src="https://www.centralparktours.net/main-file/attractions_images/central-park-zoo-2.jpg" width="100%" />
